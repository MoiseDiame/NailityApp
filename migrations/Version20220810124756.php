 ...
 */
final class Version20220810124756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vsp ADD CONSTRAINT FK_FB2A96F9B45DC79E FOREIGN KEY (presentation_picture_id) REFERENCES vsp_images (id)');
